...
"""
function create_setup(; julia_version::VersionNumber=v"1.8.1", packages::Vector{String}=String[])
...
"""
function create_run_autograder(jl_autograder::String="run_autograder.jl"; julia_version::VersionNumber=v"1.8.1", dir="/autograder")
