...
"""
function create_setup(; julia_version::VersionNumber=v"1.7.2", packages::Vector{String}=String[])
...
"""
function create_run_autograder(jl_autograder::String="run_autograder.jl"; julia_version::VersionNumber=v"1.7.2", dir="/autograder")
